...
namespace ZTools.CommentNS
{
    internal class Comment : MonoBehaviour
    {
...
#pragma warning restore 649
    ...
    internal class CommentEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            editing = EditorGUILayout.ToggleLeft("Editing", editing);

            if (editing)
            {
                EditorGUI.BeginChangeCheck();
                t.comment = EditorGUILayout.TextArea(t.comment);
            ...
            else
            {
                ...
                EditorGUILayout.TextArea(t.comment);
