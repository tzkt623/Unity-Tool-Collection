...
{
    public sealed class MainThreadingAttribute : Attribute
    {
        /// <summary>
        /// 每帧更新最大的时间开销
        /// </summary>
        ...
        public float ForFPS = 300f;
        public float TopMostTime = float.PositiveInfinity;

        public MainThreadingAttribute(float _maxTime)
        {
            MaxTime = _maxTime;
        }
    }
