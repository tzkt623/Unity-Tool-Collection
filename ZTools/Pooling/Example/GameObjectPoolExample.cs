...
namespace ZTools.PoolingNS.Example
{
    class GameObjectPoolExample : MonoBehaviour
    {
...
#pragma warning restore 649
        ...
        void Start()
        {
            ResourceManager.Instance.LoadFromResources<GameObject>(path);
            var asset = ResourceManager.Instance.GetAsset<GameObject>(path);

            pool = new GameObjectPool(asset, 1024);
            pool.DontDestroyOnLoad();

            this.transform.hierarchyCapacity = 1024;
        }
