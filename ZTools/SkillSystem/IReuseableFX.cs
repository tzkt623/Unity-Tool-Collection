...
{
    /// <summary>
    /// 实现该接口的特效，可以实现刷新重新播放的功能
    /// </summary>
    public interface IReuseableFX
    {
        void SetOwner(IReuseableFXOwner _owner);
        void Refresh();
        void Stop();
    }

    public interface IReuseableFXOwner
    {
        void OnFxDie(IReuseableFX _fx);
    }
}